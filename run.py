    ...
    with torch.no_grad():
        ...
        if args.save_video:
            ...
            render_cameras = get_render_cameras(
                batch_size=1, 
                M=120,Hier ist die vollständige `run.py` Datei ohne Kommentare, die an die Änderungen in `app.py` angepasst wurde und für Ubuntu 22.04 unter WSL2 auf Windows 11 geeignet ist:
